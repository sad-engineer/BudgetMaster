...
public class ExpenseAllFragment extends BaseListFragment<Operation, ExpenseAdapter, ExpenseSharedViewModel, OperationService> {
    ...
    private static final String TAG = "ExpenseAllFragment";
    ...
    private void initializeOperationCalculator() {
        ...
        if (operationCalculator != null) {
            ...
            config.setOperationType(OperationTypeFilter.EXPENSE);
    ...
    private void clearData() {
        ...
        if (adapter != null) {
            adapter.setExpenses(new java.util.ArrayList<>());
        }
    ...
    /**
     * Переходит на экран редактирования операции расхода
     */
    @Override
